...
public class ElasticsearchOutputStageIT {
	...
	public void testCanAddAndDelete() throws ProcessException {
		...
		Assert.assertTrue("The document should have been added to the index", addResponse.isExists());
		...
		Assert.assertFalse("The document should not be in the index", deleteResponse.isExists());
	}
